...
\begin{table}[H]
    ...
    \begin{tabular}{|p{3.7cm}|p{4.1cm}|}\hline
         ...
         /Backend AI Model&  model.py \par endhost.py\\\hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \def\arraystretch{1.24} \small
        ...
        \begin{tabular}{|p{3.7cm}|p{4.1cm}|}\hline
         Directory& File Names\\\hline
         /Place End Host&  PocketHome.pdf \par PocketHome.tex\\\hline
    \end{tabular}
...
\begin{itemize}
    ...
    \item \textbf{Location of Source Code}\par \quad \url{https://github.com/LeeSiwoong/PocketHome/tree/main/Backend\%20AI\%20Model} \\
    \item \textbf{Class Component} \begin{itemize}
    \item build.gradle.kts: It defines build configuration of project.
    \item gradle.properties: It controls the performance settings of the Gradle build system.
...
\begin{itemize}
    ...
    \item \textbf{Location of Source Code}\par \quad \url{https://github.com/LeeSiwoong/PocketHome/tree/main/Place\%20End\%20Host} \\
    \item \textbf{Class Component} \begin{itemize}
    \item build.gradle.kts: It defines build configuration of project.
    \item gradle.properties: It controls the performance settings of the Gradle build system.
