...
\begin{itemize}
    \item \textbf{Dart}\par
        \begin{figure}[h]
        \centering
        \includegraphics[width=.6\columnwidth]{Dart.png}
        \centering
        \caption{Dart} 
        \end{figure}\par
...
\begin{itemize}
    \item \textbf{Visual Studio Code}\par
        \begin{figure}[h]
        \centering
        \includegraphics[width=.4\columnwidth]{VSCode.png}
        \centering
...
\begin{itemize}
    ...
    \item     \textbf{Send Modified Data:} A button in the bottom. Tapping this button sends the modified data to the database so that those can replace the existing ones.
